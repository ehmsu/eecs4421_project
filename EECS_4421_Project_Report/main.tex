...
Finally, Raibert's hopper \cite{raibert1986legged} offers a foundational model for continuous dynamic locomotion. The robot consists of a weighted body atop a pneumatic telescoping leg connected via a pivoting hip. Its control architecture simplifies the dynamics by decoupling the system into three independent servo control loops: vertical height, forward speed, and attitude/posture.
